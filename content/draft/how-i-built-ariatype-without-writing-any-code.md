...
作为一个十年经验的工程师，我在开发 [AriaType](https://github.com/joe223/AriaType) 时做了一个实验：**用 Agentic Coding 的方式完成整个项目**——我只口述目标和边界，AI 自主完成全部工作：生成文档、规划架构、写代码、写测试、调试问题。
...
![AriaType 运行效果](/ariatype-showcase.png)
