...
AriaType continues this philosophy: a voice keyboard that's private, fast, and doesn't require setup. Check out the [GitHub repo](https://github.com/joe223/AriaType) if you're curious.